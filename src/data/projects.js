...
const projects = [
  ...
  // ─── LEVEE x HALLOWEEN ────────────────────────────────────────────────────
  {
    ...
    gallery: [
      { type: "video", src: "KcW96-hpFHk", caption: "Swaptober Promo", vertical: true },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-2.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-5.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-hero.gif",      caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-4.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-1.gif", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-hero.jpg",      caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-7.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-8.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-9.jpg", caption: "" },
      { type: "image", src: "/static/img/levee-x-halloween-gallery-6.jpg", caption: "" },
    ],
    credits: { lines: ["Ejuan Henderson", "Motion & Campaign Design"] },
  },
